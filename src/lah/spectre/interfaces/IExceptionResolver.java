...
public interface IExceptionResolver {
	...
	/**
	 * Resolve the exception, return {@literal true} if the exception is successfully resolved, {@literal false}
	 * otherwise
	 * 
	 * @param e
	 *            The exception to resolve
	 * @return {@literal true} if the exception is successfully resolved, {@literal false} otherwise
	 * @throws Exception
	 */
